/*
 * cirrus-calibration.h -- CS35L35 calibration driver
 *
...
#define FILEPATH_CRUS_RDC_L_CAL "/efs/cirrus/rdc_left_cal"
#define FILEPATH_CRUS_RDC_R_CAL "/efs/cirrus/rdc_right_cal"
